import sys
sys.path.append('/home/obashp19/scratch_CS/CPSC550/Koopman/src')
...
trainer = Trainer(params,'cuda')
total_epochs = 15
trainer.train(epochs=total_epochs, start_epoch=1, patience=5,restart=0, pretrain_ae=5)
#trainer.profile_short_run(10)
